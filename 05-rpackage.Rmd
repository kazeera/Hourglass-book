...
## Usage
The best way to run Hourglass is from the [Output: Excel File]. Download a template [here](https://github.com/kazeera/Hourglass/blob/main/example/Template_UserOptions.xlsx). Note: Keep in mind that all inputs are case-sensitive!
