...
knitr::include_graphics("images/app/GUI_1_welcome.png")
```
...
knitr::include_graphics(
  c("images/app/GUI_2_upload-data1.png", "images/app/GUI_2_upload-data2.png")
)
```
...
```{r, echo=FALSE, out.width="66%", fig.align = "center", fig.show='hold', fig.cap="Pick Comparisons tab"}
knitr::include_graphics(
  c("images/app/GUI_4_1_select-columns2.png", "images/app/GUI_4_1_select-columns2.png")
)
```
