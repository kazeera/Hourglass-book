...
```{r, echo=FALSE, out.width="66%", fig.align = "center", fig.show='hold', fig.cap="Pick Comparisons tab"}
...
```{r, echo=FALSE, out.width="66%", fig.align = "center", fig.show='hold', fig.cap="Upload Data tab"}
...
Note: Ensure R is installed, see [Installation and Usage]. If you are unsure, open R terminal and type the following to see where R is located on your computer: 
```
.libPaths()
```
