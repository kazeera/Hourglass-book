...
### Parameters 
The parameters for one stain/protein (refered to as "feature") are:
...
This is a built-in dataset object in the Hourglass R package. Rename the example dataset variable (to make it smaller). Note: ds = **d**ata**s**et
```{r}
