...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="Heterogeneity barplot stacked (left) created by Hourglass."}
knitr::include_graphics(c("images/plots/hetplot stacked.png"))
```
...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="Patient paired plot created by Hourglass."}
...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="Overview boxplot created by Hourglass."}
...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="Individual boxplot with statistics created by Hourglass."}
...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="Overview boxplots created by Hourglass."}
knitr::include_graphics(c("images/plots/boxplot indiv.png"))
```

7.  **Profile Barplot**
+ Compare set of markers across different strata for each patient/sample.
```{r, echo=FALSE, out.width="66%", fig.align = "center", fig.show='hold', fig.cap="Profile barplot stacked and filled to 100%, created by Hourglass."}
knitr::include_graphics(c("images/plots/profile barplot filled.png","images/plots/profile barplot filled.png"))
```
...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="Heatmaps showing expression of features, created by Hourglass."}
...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="Plots showing fold-change values (color gradients) and p-values (stars/number), created by Hourglass."}
...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="Correlation plots created by Hourglass."}
...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="Correlation scatter plots created by Hourglass."}
...
```{r, echo=FALSE, out.width="50%", fig.align = "center", fig.show='hold', fig.cap="ID table (csv file) created by Hourglass."}
